# Data Analytics Portfolio — Juan Marcelo Párraga Calizaya

Data Analyst with 4+ years in analytics and 10+ years in telecommunications engineering. Specialized in Big Data pipelines, subscriber segmentation, KPI/KQI frameworks, and BI dashboards. Currently pursuing an MSc in Business Analytics at Pontificia Universidad Católica de Chile.

📍 La Paz, Bolivia · Open to remote opportunities  
🔗 [LinkedIn](https://www.linkedin.com/in/marcelo-parraga) · 📧 mparraga19891@gmail.com
...
| Area | Tools |
|------|-------|
| BI & Visualization | Power BI · Tableau · FineBI |
| Languages | Python (pandas · NumPy · matplotlib · scikit-learn · geopandas) · SQL · R |
| Big Data | Hadoop · Hive · Spark |
| Databases | PostgreSQL · SQL Server · MongoDB |
| Automation | Power Query · Power Pivot · Advanced Excel · VBA |
| GIS | QGIS · GeoPandas |
| OS | Linux · Windows |
...
🔴 **[Live Dashboard](https://app.powerbi.com/view?r=eyJrIjoiMDc3MWYxY2ItYTk1My00YTBmLWI0ZTEtZmFhY2Q2N2I0YmUwIiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M2VkN2ZmOTVhMCJ9)**
